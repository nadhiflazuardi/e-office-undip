...
@section('container')
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                @if (auth()->user()->hasRole('Sekretaris'))
                    <button class="nav-link active" id="nav-semua-tab" data-bs-toggle="tab" data-bs-target="#nav-semua"
                        type="button" role="tab" aria-controls="nav-semua" aria-selected="false">Semua Rapat</button>
                @endif
                <button class="nav-link @if(!auth()->user()->hasRole('Sekretaris')) active @endif" id="nav-mendatang-tab" data-bs-toggle="tab" data-bs-target="#nav-mendatang"
    ...
    py-2 px-4 fs-5 text-capitalize"
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade @if(!auth()->user()->hasRole('Sekretaris')) show  active @endif" id="nav-mendatang" role="tabpanel"
                    aria-labelledby="nav-mendatang-tab" tabindex="0">
                    @foreach ($upcomingRapats as $rapat)
                        <a href="{{ route('rapat.show', ['rapat' => $rapat->id]) }}"
